                        ...
                        <div className="form-items">
                            ...
                            <div className="card">
                                <div className="card-header">
                                    ...
                                    <p className="label">Are you a vendor? <Link href={"/business"} className="btn">Vendor Login</Link></p>
                                ...
                                <div className="form-item" style={formik.errors.username && formik.touched.username ? errorStyle : {}}>
                                    <input type="text" placeholder="Email or phone " name="username" {...formik.getFieldProps('username')} />
                                ...
                                <ButtonDark onClick={formik.handleSubmit}>{isLoading ? <Spinner1 /> : "Log in"}</ButtonDark>
                                <div className="already-have-account">
                                    <h2>Dont have an account? </h2> <Link href={'/user/signup'} className="btn">Free SignUp</Link>
                                </div>
                            </div>
