  ...
  return (
    <Section className="section">
          ...
          <div className="row review-rating-details">
            <div className="row">
              <div className="review-rating-rating">
                {reviewData.place_rating}
              </div>
              <div style={{ display: "flex" }} className="review_stars">
                {renderStars(Math.floor(reviewData.place_rating))}
              </div>
            </div>
      ...
      {isOffCanvasReviewOpen && (
        ...
        <div id="sidebar">
          <div className="row close-and-heading">
            <div className="close-btn reviewer_name" onClick={closeOffCanvaReview}>
              X
            </div>
