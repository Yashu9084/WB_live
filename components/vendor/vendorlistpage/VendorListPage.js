...
export default function VendorListPage(props){
    ...
    return (
        ...
        <Offer/>
        {/* <Heading /> */}
        <TitleCaption category={category} locality={locality} city={city} count={result.count} caption={result.meta?.caption} />
        <VendorGrid vendors={result} category={category} city={city} locality={locality}/>
