    ...
    return (
        ...
        <Wrapper>
            <div className=" dropdown city-dropdown">
                ...
                <label>
                    <select name='cities' value={selectedCity} onChange={(e) => cityhandler(e)}>
                    ...
                    <select name='venue' onChange={(e) => venueTypeHanlder(e)}>
                        <option value={null} > Select Venue</option>
                        {
                            venueCategogies?.map((venueCategogie) => {
                                return (<option value={venueCategogie.slug} key={venueCategogie.id}> {venueCategogie.name}</option>)
                            })
                        }
